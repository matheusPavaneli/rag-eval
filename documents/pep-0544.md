...
where to apply a particular solution. See section on rejected ideas at the end of this PEP for additional motivation.
...
* Abstract classes defined in `collections.abc` module [collections-abc]_
  ...
  of protocols. As discussed in rationale,
  ...
  will be provided, see detailed discussion below.
...
* TypeScript [typescript]_ provides support for user-defined classes and
  ...
  this; see rejected ideas. In general, the idea of
...
must be protocols. A protocol can't extend a regular class, see rejected ideas for rationale.
...
this behavior is opt-in, see section on rejected
ideas for examples.
...
in specification, protocols are different from Java interfaces in several
