...
- **Author:** Neil Schemenauer <nas@arctrix.com>, Tim Peters <tim.peters@gmail.com>, Magnus Lie Hetland <magnus@hetland.org>
- **Status:** Final
...
Another alternative would be to make tokenize an PEP 234,
delivering the
...
PEP 234, but of an especially powerful kind.
...
this conforms to the PEP 234, so in particular can be used in
