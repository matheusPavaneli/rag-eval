...
Guido stated [#] that any solution to better string interpolation
...
their associated Unicode characters [#].
...
programming languages [#]. This feature is implemented in many
