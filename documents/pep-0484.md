...
then, there has always been an implicit goal to use them for type hinting, which is listed as the first possible use case
in said PEP.
...
A few other forms of alternative syntax have been proposed, e.g. the introduction of a `where` keyword, and Cobra-inspired
